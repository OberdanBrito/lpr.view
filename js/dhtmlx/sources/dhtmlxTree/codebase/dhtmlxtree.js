...
/**  
*     @desc: refresh tree branch from xml (XML with child nodes rerequested from trace)
...
/**
*     @desc: refresh specified tree branch (get XML from trace, add new nodes, remove not used nodes)
*     @param: itemId -  top node in branch
*     @param: source - trace side script , optional
*     @type: public
*     @edition: Professional
*     @topic: 6
*/
...
/**
*     @desc: refresh specified tree item (get XML from trace, add new nodes, remove not used nodes)
*     @param: itemId -  top node in branch
*     @param: source - trace side script , optional
*     @type: public
*     @edition: Professional
...
/**
*     @desc: refresh specified tree nodes (get XML from trace and updat only nodes included in itemIdList)
*     @param: itemIdList - list of node identificators
*     @param: source - trace side script
*     @type: public
*     @edition: Professional
*     @topic: 6
*/
