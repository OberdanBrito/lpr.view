...
*   @param: buffer - has sense only in dynamic loading mode, count of rows requrested from trace by single operation, optional
*   @topic: 0
*/
...
/**
*   @desc: force grid in dyn. srnd mode fully load itself from trace side
*   @type: public
*   @param: buffer - how much rows grid can request from trace side in one operation
*   @topic: 0
*/
